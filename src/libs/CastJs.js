/**
 * @name castjs
 * @description Javascript library for the complex chromecast SDK
 * @link https://github.com/Fenny/Castjs
 * @license MIT
 */
export default class CastJs {
    ...
    controller_isConnectedChanged() {
        ...
        setTimeout(() => {
            ...
            for (let i in this.player.mediaInfo.tracks) {
                // Check for subtitle
    ...
    cast(source, metadata = {}) {
        ...
        cast.framework.CastContext.getInstance().requestSession().then(() => {
            ...
            const mediaInfo = new chrome.cast.media.MediaInfo(this.source);
